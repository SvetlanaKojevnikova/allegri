      ...
      <div className="container">
        <div className="header__nav">
          ...
          >
            ...
            />
            <path
              d="M35.917 15.7846V0.552734H37.5271V14.4394H42.2679V15.7846H35.917Z"
              fill="#0F303F"
            />
            <path
          ...
          <div className="header__rigth">
            ...
            <div className="header__icons">
              <a href="" className="header__icons-link">
                ...
                >
                  <path
                    d="M14.9282 7C14.8452 6.42469 14.6906 5.86065 14.4672 5.32122C14.1154 4.47194 13.5998 3.70026 12.9497 3.05025C12.2997 2.40024 11.5281 1.88463 10.6788 1.53284C9.8295 1.18106 8.91925 1 8 1C7.08075 1 6.17049 1.18106 5.32122 1.53284C4.47194 1.88463 3.70026 2.40024 3.05025 3.05025C2.40024 3.70026 1.88463 4.47194 1.53284 5.32122C1.3094 5.86065 1.15484 6.42469 1.0718 7L14.9282 7ZM15.9373 7C15.8482 6.29303 15.6649 5.59962 15.391 4.93853C14.989 3.96793 14.3997 3.08601 13.6569 2.34315C12.914 1.60028 12.0321 1.011 11.0615 0.608964C10.0909 0.206926 9.05057 0 8 0C6.94942 0 5.90914 0.206926 4.93853 0.608964C3.96793 1.011 3.08601 1.60028 2.34315 2.34315C1.60028 3.08601 1.011 3.96793 0.608963 4.93853C0.335133 5.59962 0.151816 6.29303 0.0627457 7C0.0210429 7.331 0 7.66498 0 8L16 8C16 7.66498 15.979 7.331 15.9373 7Z"
                    fill="#0F303F"
                  />
                </svg>
              </a>
